...
return [cljs.core.str((function (){var pred__26959 = cljs.core.instance_QMARK_;
var expr__26960 = reactive_val;
if(cljs.core.truth_(pred__26959.call(null,reagent.ratom.RAtom,expr__26960))){
return "ra";
} else {
if(cljs.core.truth_(pred__26959.call(null,reagent.ratom.RCursor,expr__26960))){
return "rc";
} else {
if(cljs.core.truth_(pred__26959.call(null,reagent.ratom.Reaction,expr__26960))){
return "rx";
} else {
if(cljs.core.truth_(pred__26959.call(null,reagent.ratom.Track,expr__26960))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1495401524034