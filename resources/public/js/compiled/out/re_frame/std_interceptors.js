...
var vec__27402_27405 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_27406 = cljs.core.nth.call(null,vec__27402_27405,(0),null);
var only_after_27407 = cljs.core.nth.call(null,vec__27402_27405,(1),null);
var db_changed_QMARK__27408 = (cljs.core.some_QMARK_.call(null,only_before_27406)) || (cljs.core.some_QMARK_.call(null,only_after_27407));
if(db_changed_QMARK__27408){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_27406);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_27407);
...
var map__27415 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__27415__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__27415__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__27423 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__27423__$1;
var event = cljs.core.get.call(null,map__27423__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__26207__auto___27426 = arguments.length;
var i__26208__auto___27427 = (0);
while(true){
if((i__26208__auto___27427 < len__26207__auto___27426)){
args__26214__auto__.push((arguments[i__26208__auto___27427]));

var G__27428 = (i__26208__auto___27427 + (1));
i__26208__auto___27427 = G__27428;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__26215__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq27425){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq27425));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__25132__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__26214__auto__ = [];
var len__26207__auto___27434 = arguments.length;
var i__26208__auto___27435 = (0);
while(true){
if((i__26208__auto___27435 < len__26207__auto___27434)){
args__26214__auto__.push((arguments[i__26208__auto___27435]));

var G__27436 = (i__26208__auto___27435 + (1));
i__26208__auto___27435 = G__27436;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__26215__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__27429_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__27430_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__27430_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq27431){
var G__27432 = cljs.core.first.call(null,seq27431);
var seq27431__$1 = cljs.core.next.call(null,seq27431);
var G__27433 = cljs.core.first.call(null,seq27431__$1);
var seq27431__$2 = cljs.core.next.call(null,seq27431__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__27432,G__27433,seq27431__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1495401524734