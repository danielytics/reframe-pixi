...
return (new CustomEvent(event_name,(function (){var obj33880 = {"detail":data};
return obj33880;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__25120__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__25120__auto__)){
var and__25120__auto____$1 = (window["CustomEvent"]);
...
var args33885 = [];
var len__26207__auto___33891 = arguments.length;
var i__26208__auto___33892 = (0);
while(true){
if((i__26208__auto___33892 < len__26207__auto___33891)){
args33885.push((arguments[i__26208__auto___33892]));

var G__33893 = (i__26208__auto___33892 + (1));
i__26208__auto___33892 = G__33893;
continue;
} else {
}
break;
...
var f = (function (){var pred__33888 = cljs.core._EQ_;
var expr__33889 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__33888.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__33889))){
return ((function (pred__33888,expr__33889){
return (function (p1__33881_SHARP_){
return console.warn(p1__33881_SHARP_);
});
;})(pred__33888,expr__33889))
} else {
if(cljs.core.truth_(pred__33888.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__33889))){
return ((function (pred__33888,expr__33889){
return (function (p1__33882_SHARP_){
return console.debug(p1__33882_SHARP_);
});
;})(pred__33888,expr__33889))
} else {
if(cljs.core.truth_(pred__33888.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__33889))){
return ((function (pred__33888,expr__33889){
return (function (p1__33883_SHARP_){
return console.error(p1__33883_SHARP_);
});
;})(pred__33888,expr__33889))
} else {
return ((function (pred__33888,expr__33889){
return (function (p1__33884_SHARP_){
return console.log(p1__33884_SHARP_);
});
;})(pred__33888,expr__33889))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__33895){
...
var opts = map__33898__$1;
var eval_fn = cljs.core.get.call(null,map__33898__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__33900_SHARP_);
});})(new_def))
);
...
return (function (p__33901){
var vec__33902 = p__33901;
var ky = cljs.core.nth.call(null,vec__33902,(0),null);
...
var args33905 = [];
var len__26207__auto___33908 = arguments.length;
var i__26208__auto___33909 = (0);
while(true){
if((i__26208__auto___33909 < len__26207__auto___33908)){
args33905.push((arguments[i__26208__auto___33909]));

var G__33910 = (i__26208__auto___33909 + (1));
i__26208__auto___33909 = G__33910;
continue;
} else {
}
break;
...
if(cljs.core.truth_((function (){var and__25120__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1495401532236