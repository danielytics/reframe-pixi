...
var o37683 = temp__4655__auto__;
var temp__4655__auto____$1 = (o37683["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o37684 = temp__4655__auto____$1;
return (o37684["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__37609__auto__ = f;
return (o__37609__auto__["toString"]).call(o__37609__auto__);
} else {
return "";
}
}catch (e37686){var _ = e37686;
return "";
}});
...
try{var o__37609__auto___37689 = t;
(o__37609__auto___37689["cljs$lang$ctorPrWriter"]).call(o__37609__auto___37689,t,writer);
}catch (e37688){var __37690 = e37688;
}
...
var char_code = (function (){var o__37609__auto__ = (new String(char$));
return (o__37609__auto__["charCodeAt"]).call(o__37609__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__37609__auto__ = String;
return (o__37609__auto__["fromCharCode"]).call(o__37609__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__37692 = num_code;
switch (G__37692) {
case (1):
return (185);
...
var o__37609__auto__ = String;
return (o__37609__auto__["fromCharCode"]).call(o__37609__auto__,superscript_code);
});
/**
...
}catch (e37698){var _e__37616__auto__ = e37698;
return false;
}})())){
...
var vec__37699 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__37699,(0),null);
...
var or__25132__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
if(cljs.core.truth_(temp__4655__auto__)){
var o37704 = temp__4655__auto__;
var temp__4655__auto____$1 = (o37704["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o37705 = temp__4655__auto____$1;
return (o37705["nameToPath"]);
} else {
return null;
}
} else {
...
var len__26207__auto___37712 = arguments.length;
var i__26208__auto___37713 = (0);
while(true){
if((i__26208__auto___37713 < len__26207__auto___37712)){
args__26214__auto__.push((arguments[i__26208__auto___37713]));

var G__37714 = (i__26208__auto___37713 + (1));
i__26208__auto___37713 = G__37714;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__26215__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__37708){
var vec__37709 = p__37708;
var ns_detector = cljs.core.nth.call(null,vec__37709,(0),null);
var effective_detector = (function (){var or__25132__auto__ = ns_detector;
if(cljs.core.truth_(or__25132__auto__)){
return or__25132__auto__;
} else {
...
var G__37715 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__37716 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__37715;
remaining_tokens = G__37716;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq37706){
var G__37707 = cljs.core.first.call(null,seq37706);
var seq37706__$1 = cljs.core.next.call(null,seq37706);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__37707,seq37706__$1);
});
...
var vec__37724 = cljs.core.split_with.call(null,(function (p1__37720_SHARP_){
return cljs.core.not_EQ_.call(null,p1__37720_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__37724,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__37724,(1),null);
...
var vec__37730 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__37730,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__37730,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__37733 = cljs.core.rest.call(null,remaining_tokens);
var G__37734 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__37733;
name_tokens = G__37734;
continue;
} else {
...
var args37735 = [];
var len__26207__auto___37747 = arguments.length;
var i__26208__auto___37748 = (0);
while(true){
if((i__26208__auto___37748 < len__26207__auto___37747)){
args37735.push((arguments[i__26208__auto___37748]));

var G__37749 = (i__26208__auto___37748 + (1));
i__26208__auto___37748 = G__37749;
continue;
} else {
}
break;
...
var vec__37738 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__37738,(0),null);
var arity = cljs.core.nth.call(null,vec__37738,(1),null);
var vec__37741 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__37741,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__37741,(1),null);
var vec__37744 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__37744,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__37744,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__37744,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__37744,(3),null);
...
var args37751 = [];
var len__26207__auto___37757 = arguments.length;
var i__26208__auto___37758 = (0);
while(true){
if((i__26208__auto___37758 < len__26207__auto___37757)){
args37751.push((arguments[i__26208__auto___37758]));

var G__37759 = (i__26208__auto___37758 + (1));
i__26208__auto___37758 = G__37759;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args37751.length)].join('')));
...
var vec__37754 = result;
var munged_ns = cljs.core.nth.call(null,vec__37754,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__37754,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__37754,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__37754,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__37754,(4),null);
var arity = cljs.core.nth.call(null,vec__37754,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__37767 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__37767,(0),null);
var args = cljs.core.nth.call(null,vec__37767,(1),null);
var vec__37770 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__37770,(0),null);
var name = cljs.core.nth.call(null,vec__37770,(1),null);
...
var G__37773 = (arity + (1));
var G__37774 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__37775){
var vec__37779 = p__37775;
var arity = cljs.core.nth.call(null,vec__37779,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__37779,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__25132__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__25132__auto__)){
return or__25132__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__37782_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__37783_SHARP_);
...
var args__26214__auto__ = [];
var len__26207__auto___37790 = arguments.length;
var i__26208__auto___37791 = (0);
while(true){
if((i__26208__auto___37791 < len__26207__auto___37790)){
args__26214__auto__.push((arguments[i__26208__auto___37791]));

var G__37792 = (i__26208__auto___37791 + (1));
i__26208__auto___37791 = G__37792;
continue;
} else {
}
break;
...
var argseq__26215__auto__ = ((((1) < args__26214__auto__.length))?(new cljs.core.IndexedSeq(args__26214__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__26215__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__37786){
var vec__37787 = p__37786;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__37787,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq37784){
var G__37785 = cljs.core.first.call(null,seq37784);
var seq37784__$1 = cljs.core.next.call(null,seq37784);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__37785,seq37784__$1);
});
...
var G__37794 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__37794) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__25132__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__25132__auto__)){
return or__25132__auto__;
} else {
...
return [cljs.core.str((cljs.core.truth_((function (){var and__25120__auto__ = include_ns_QMARK_;
...
return [cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str(protocol_name)].join(''):null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str((cljs.core.truth_((function (){var or__25132__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__25132__auto__)){
return or__25132__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__37801__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__37801__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__37801__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__37801__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__37802 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__37802,(0),null);
var fn_name = cljs.core.nth.call(null,vec__37802,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__37802,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__37802,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__37802,(4),null);
var arity = cljs.core.nth.call(null,vec__37802,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__25120__auto__ = protocol_ns;
if(cljs.core.truth_(and__25120__auto__)){
return cljs.core.not.call(null,(function (){var and__25120__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str((function (){var or__25132__auto__ = protocol_part;
if(cljs.core.truth_(or__25132__auto__)){
return or__25132__auto__;
} else {
return fn_part;
...
var o__37609__auto__ = f;
return (o__37609__auto__["getBasis"]).call(o__37609__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__25120__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__25120__auto__)){
...
}catch (e37807){var _e__37616__auto__ = e37807;
...
var G__37808 = (obj[cljs.core.first.call(null,path)]);
var G__37809 = cljs.core.rest.call(null,path);
obj = G__37808;
path = G__37809;
continue;
} else {
...
var partition_bits = (function (){var or__25132__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__25132__auto__)){
return or__25132__auto__;
} else {
return (0);
...
return (function (accum,p__37814){
var vec__37815 = p__37814;
var bit = cljs.core.nth.call(null,vec__37815,(0),null);
var protocol = cljs.core.nth.call(null,vec__37815,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__37818){
var vec__37822 = p__37818;
var ns = cljs.core.nth.call(null,vec__37822,(0),null);
var name = cljs.core.nth.call(null,vec__37822,(1),null);
var selector = cljs.core.nth.call(null,vec__37822,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__37831,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__37831,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__37831,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__37825_SHARP_){
return (obj[cljs.core.first.call(null,p1__37825_SHARP_)]);
});})(name,sorted_matches,vec__37831,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1495401537328