...
var len__26207__auto___38686 = arguments.length;
var i__26208__auto___38687 = (0);
while(true){
if((i__26208__auto___38687 < len__26207__auto___38686)){
args__26214__auto__.push((arguments[i__26208__auto___38687]));

var G__38688 = (i__26208__auto___38687 + (1));
i__26208__auto___38687 = G__38688;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__26215__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq38683){
var G__38684 = cljs.core.first.call(null,seq38683);
var seq38683__$1 = cljs.core.next.call(null,seq38683);
var G__38685 = cljs.core.first.call(null,seq38683__$1);
var seq38683__$2 = cljs.core.next.call(null,seq38683__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__38684,G__38685,seq38683__$2);
});
...
if(cljs.core.truth_((function (){var or__25132__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__25738__auto__,writer__25739__auto__,opt__25740__auto__){
return cljs.core._write.call(null,writer__25739__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__25120__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__25120__auto__){
var or__25132__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__25132__auto__)){
return or__25132__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__38689_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__38689_SHARP_));
})))){
...
var map__38698 = opts;
var map__38698__$1 = ((((!((map__38698 == null)))?((((map__38698.cljs$lang$protocol_mask$partition0$ & (64))) || (map__38698.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__38698):map__38698);
var markup_db = cljs.core.get.call(null,map__38698__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__25132__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e38702){var _e__37616__auto__ = e38702;
return false;
}})();
if(cljs.core.truth_(or__25132__auto__)){
return or__25132__auto__;
...
}catch (e38704){var _e__37616__auto__ = e38704;
return false;
}}
})())){
...
var _STAR_current_state_STAR_38709 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__38710 = opts;
var map__38710__$1 = ((((!((map__38710 == null)))?((((map__38710.cljs$lang$protocol_mask$partition0$ & (64))) || (map__38710.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__38710):map__38710);
var markup_db = cljs.core.get.call(null,map__38710__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_38709;
}});
...
;
var temp__4655__auto___38715 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___38715)){
var managed_print_level_38716 = temp__4655__auto___38715;
var _STAR_print_level_STAR_38714_38717 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_38716;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_38714_38717,managed_print_level_38716,temp__4655__auto___38715,writer,opts,job_fn){
return (function (p1__38712_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__38712_SHARP_,null);
});})(_STAR_print_level_STAR_38714_38717,managed_print_level_38716,temp__4655__auto___38715,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_38714_38717;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1495401538745