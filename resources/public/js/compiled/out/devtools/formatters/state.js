...
var len__26207__auto___38677 = arguments.length;
var i__26208__auto___38678 = (0);
while(true){
if((i__26208__auto___38678 < len__26207__auto___38677)){
args__26214__auto__.push((arguments[i__26208__auto___38678]));

var G__38679 = (i__26208__auto___38678 + (1));
i__26208__auto___38678 = G__38679;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__26215__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq38675){
var G__38676 = cljs.core.first.call(null,seq38675);
var seq38675__$1 = cljs.core.next.call(null,seq38675);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__38676,seq38675__$1);
});
...
return (p1__38680_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1495401538583