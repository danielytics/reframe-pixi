...
var reader = (function (){var or__25132__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__25132__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__25132__auto__)){
return or__25132__auto__;
} else {
return (128);
...
var map__41137 = top_item;
var map__41137__$1 = ((((!((map__41137 == null)))?((((map__41137.cljs$lang$protocol_mask$partition0$ & (64))) || (map__41137.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__41137):map__41137);
var file = cljs.core.get.call(null,map__41137__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__41137__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__41137__$1,new cljs.core.Keyword(null,"column","column",2078222095));
...
var temp__4655__auto___41139 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___41139)){
var seen_errors_41140 = temp__4655__auto___41139;
if(cljs.core.truth_(seen_errors_41140.has(self))){
} else {
seen_errors_41140.add(self);

var temp__4657__auto___41141 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___41141)){
var sense_41142 = temp__4657__auto___41141;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_41142)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1495401545364