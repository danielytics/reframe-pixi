...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__25738__auto__,writer__25739__auto__,opt__25740__auto__){
return cljs.core._write.call(null,writer__25739__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__26763 = o;
(G__26763[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__25120__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__25120__auto__){
var and__25120__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__26772 = jsprops;
(G__26772["defaultValue"] = value);

(G__26772["onChange"] = ((function (G__26772,v,value,on_change){
return (function (p1__26769_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__26769_SHARP_);
});})(G__26772,v,value,on_change))
);

(G__26772["ref"] = ((function (G__26772,v,value,on_change){
return (function (p1__26770_SHARP_){
return (this$["cljsInputElement"] = p1__26770_SHARP_);
});})(G__26772,v,value,on_change))
);
...
var vec__26779 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__26779,(0),null);
var id = cljs.core.nth.call(null,vec__26779,(1),null);
var class$ = cljs.core.nth.call(null,vec__26779,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___26784 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___26784 == null)){
} else {
var key_26785 = temp__4661__auto___26784;
(jsprops["key"] = key_26785);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__26787 = (new reagent.impl.template.NativeWrapper());
(G__26787["name"] = c);
...
var len__26207__auto___26793 = arguments.length;
var i__26208__auto___26794 = (0);
while(true){
if((i__26208__auto___26794 < len__26207__auto___26793)){
args__26214__auto__.push((arguments[i__26208__auto___26794]));

var G__26795 = (i__26208__auto___26794 + (1));
i__26208__auto___26794 = G__26795;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__26215__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq26791){
var G__26792 = cljs.core.first.call(null,seq26791);
var seq26791__$1 = cljs.core.next.call(null,seq26791);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__26792,seq26791__$1);
});
...
break;
default:
var G__26799 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__26799;
continue;
...
var n__26047__auto___26802 = a.length;
var i_26803 = (0);
while(true){
if((i_26803 < n__26047__auto___26802)){
(a[i_26803] = reagent.impl.template.as_element.call(null,(a[i_26803])));
...
var a = cljs.core.into_array.call(null,s);
var n__26047__auto___26805 = a.length;
var i_26806 = (0);
while(true){
if((i_26806 < n__26047__auto___26805)){
var val_26807 = (a[i_26806]);
if((cljs.core.vector_QMARK_.call(null,val_26807)) && ((reagent.impl.template.key_from_vec.call(null,val_26807) == null))){
(o["no-key"] = true);
} else {
}

(a[i_26806] = reagent.impl.template.as_element.call(null,val_26807));

var G__26808 = (i_26806 + (1));
i_26806 = G__26808;
continue;
} else {
}
...
var ctx = ({});
var vec__26812 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__26812,(0),null);
var derefed = cljs.core.nth.call(null,vec__26812,(1),null);
...
var G__26816 = (cljs.core.count.call(null,argv) - first_child);
switch (G__26816) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__26816){
...
//# sourceMappingURL=template.js.map?rel=1495401523722